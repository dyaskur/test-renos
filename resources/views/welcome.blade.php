...
<head>
    ...
    <title>Renos Test Case Demo</title>
                        ...
                        <div class="p- border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                <svg width="20" height="20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 30 30" class="w-8 h-8 text-gray-500">

                                    <circle cx="19" cy="13" r="8" stroke="gray" fill="transparent" stroke-width="5"/>

                                </svg>
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">
                                    <a href="?keyword={{$item}}"> {{$item}}</a>
                                </div>
                            </div>
